...
class AnalysisControllerStatusAndDeleteApiTest {
    ...
    @Test
    void shouldUpdateAnalysisStatus() throws Exception {
        mockMvc.perform(put("/api/analysis/analysis-77/status")
    ...
    void shouldDeleteAnalysis() throws Exception {
        mockMvc.perform(delete("/api/analysis/analysis-77"))
    ...
    private static final class StubAnalysisService implements AnalysisService {
        ...
        private AnalysisResult sampleResult(String status) {
